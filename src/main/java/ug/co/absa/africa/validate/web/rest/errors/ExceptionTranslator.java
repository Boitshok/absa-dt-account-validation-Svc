package ug.co.absa.africa.validate.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.africa.validate.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.africa.validate.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.africa.validate.service.InvalidPasswordException
