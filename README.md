...
To build the final jar and optimize the AccountValidationSvc application for production, run:
...
Then navigate to [http://localhost:9077](http://localhost:9077) in your browser.
